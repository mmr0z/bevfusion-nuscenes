...
import torch
# WYŁĄCZAMY cuDNN - to zmusi PyTorch do użycia kodu, który Twoja karta rozumie
...
def register_local_checkpoint_compat():
    ...
    def load_from_local(filename, map_location):
        ...
        # Trust project-local checkpoints and keep pre-2.6 resume behavior.
        return torch.load(
            filename, map_location=map_location, weights_only=False)

    CheckpointLoader.register_scheme(prefixes='', loader=load_from_local,
                                     force=True)
