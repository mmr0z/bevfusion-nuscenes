_base_ = ['./bevfusion_lidar_voxel0075_second_secfpn_1xb1-12e_nus-3d-fast.py']

model = dict(bbox_head=dict(num_proposals=160))
...
custom_hooks = [dict(type='DisableObjectSampleHook', disable_after_epoch=10)]
